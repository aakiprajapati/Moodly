...
/// - "Source Serif Pro" for all body copy, labels, and buttons.
class AppTextStyles {
  AppTextStyles._();

  // Logo / wordmark ("Moodly")
  static TextStyle logo({double fontSize = 32, Color? color}) =>
      GoogleFonts.petitFormalScript(
        fontSize: fontSize,
        color: color ?? AppColors.deepRose,
        fontWeight: FontWeight.w400,
      );

  // Script section headings, e.g. "Cycle at a Glance", "Mood Trends"
  static TextStyle scriptHeading({double fontSize = 22, Color? color}) =>
      GoogleFonts.petitFormalScript(
        fontSize: fontSize,
